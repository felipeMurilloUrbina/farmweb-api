...
namespace Farmacia.POS.Model
{
    ...
    public class GruposConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Grupos>
    {
        public GruposConfiguration()
            : this("dbo")
        {
        }

        public GruposConfiguration(string schema)
        {
            ToTable("Grupos", schema);
            HasKey(x => x.Id);
            ...
            // Foreign keys
            HasRequired(a => a.Empresa).WithMany(b => b.Grupos).HasForeignKey(c => c.EmpresaId).WillCascadeOnDelete(false); // FK_Grupos_Empresas
        }
    }
