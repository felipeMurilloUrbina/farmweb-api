...
namespace Farmacia.POS.WebApi.Controllers
{
    ...
    {
        readonly ServicioEntrada _servicio = null;
        Contexto _contexto = null;
        string _element = "Entrada";
        public EntradasController(): base()
        {
            _contexto = new Contexto();
            var repository = new EntradaRepository(_avikaDB, _logger);
            this._servicio = new ServicioEntrada(repository);
        }
        /// <summary>
        /// Get {Entradas}
        /// </summary>
        /// <returns>List of Entradas </returns>
        [Route(""), HttpGet]
