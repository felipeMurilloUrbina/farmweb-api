...
namespace Farmacia.POS.WebApi.Controllers
{
    ...
    public class LineasController : BaseApiController
    {
        readonly ServicioLine _servicio = null;
        Contexto _contexto = null;
        string _element = "Line";
        public LineasController(): base()
        {
            _contexto = new Contexto();
            var repository = new LineRepository(_avikaDB, _logger);
            this._servicio = new ServicioLine(repository);
        }
        /// <summary>
        /// Get {Lineas}
        /// </summary>
        ...
        public async Task<IHttpActionResult> Post(LineDto lineas)
        {
            if (category == null)
        ...
        public async Task<IHttpActionResult> Put(LineDto lineas)
        {
            if (category == null)
                return BadRequest(String.Format(Resources.RequestEmpty, _element));
            var principal = RequestContext.Principal as ClaimsPrincipal;
