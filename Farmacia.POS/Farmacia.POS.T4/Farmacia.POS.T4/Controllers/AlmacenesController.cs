...
namespace Farmacia.POS.WebApi.Controllers
{
    ...
    public class AlmacenesController : BaseApiController
    {
        readonly ServicioAlmacen _servicio = null;
        Contexto _contexto = null;
        string _element = "Almacen";
        ...
        /// Get {Almacenes}
        /// </summary>
        /// <returns>List of Almacenes </returns>
        [Route(""), HttpGet]
        ...
        public async Task<IHttpActionResult> Post(AlmacenDto almacenes)
        {
            if (category == null)
        ...
        public async Task<IHttpActionResult> Put(AlmacenDto almacenes)
        {
            if (category == null)
                return BadRequest(String.Format(Resources.RequestEmpty, _element));
            var principal = RequestContext.Principal as ClaimsPrincipal;
