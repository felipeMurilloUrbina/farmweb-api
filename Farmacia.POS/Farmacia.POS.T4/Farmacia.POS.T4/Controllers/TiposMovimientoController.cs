...
{
    [RoutePrefix("api/tiposMovimiento")]
    public class TiposMovimientoController : BaseApiController
    {
        readonly ServicioTiposMovimient _servicio = null;
        Contexto _contexto = null;
        string _element = "TiposMovimient";
        public TiposMovimientoController(): base()
        {
            _contexto = new Contexto();
            var repository = new TiposMovimientRepository(_avikaDB, _logger);
            this._servicio = new ServicioTiposMovimient(repository);
        }
        /// <summary>
        /// Get {TiposMovimiento}
        /// </summary>
        /// <returns>List of TiposMovimiento </returns>
        [Route(""), HttpGet]
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <returns>TiposMovimiento </returns>
        [HttpGet]
        ...
        /// <summary>
        /// Post to TiposMovimiento
        /// </summary>
        /// <param name="TiposMovimiento"></param>
        /// <returns></returns>
