...
{
    public class ServicioGrupo:IServicio, Repositorio<Grupo>
    {
        ...
        public async Task<Pagination<Grupo>> Obtener(int? page, int? qty)
        {
        ...
        public async Task<string> Actualizar(Grupo grupo)
        {
            //if (grupo.Id == 0)
            //    return "";
