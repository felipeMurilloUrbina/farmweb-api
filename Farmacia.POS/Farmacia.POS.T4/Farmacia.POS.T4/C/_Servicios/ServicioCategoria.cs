...
{
    public class ServicioCategoria:IServicio, Repositorio<Categoria>
    {
        ...
        public async Task<Pagination<Categoria>> Obtener(int? page, int? qty)
        {
        ...
        public async Task<string> Actualizar(Categoria categoria)
        {
            //if (categoria.Id == 0)
            //    return "";
