...
{
    public class ServicioLote:IServicio, Repositorio<Lote>
    {
        ...
        public async Task<Pagination<Lote>> Obtener(int? page, int? qty)
        {
            var _companies = _repository.Get(page, qty).Result;
            return _companies;
        }
        public async Task<Lote> Obtener(int id)
        {
        ...
        public async Task<string> Actualizar(Lote lote)
        {
            //if (lote.Id == 0)
            //    return "";
