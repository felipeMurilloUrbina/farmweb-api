...
{
    public class ServicioTiposMovimiento:IServicio, Repositorio<TiposMovimiento>
    {
        private readonly CompanyRepository _repository = null;
        string _element = "Sucursal";
        public ServicioTiposMovimiento()
        {
            this._repository = repository;
        }

        public async Task<Pagination<TiposMovimiento>> Obtener(int? page, int? qty)
        {
            var _companies = _repository.Get(page, qty).Result;
            return _companies;
        }
        public async Task<TiposMovimiento> Obtener(int id)
        {
        ...
        public async Task<string> Actualizar(TiposMovimiento tiposMovimiento)
        {
            //if (tiposMovimiento.Id == 0)
            //    return "";
