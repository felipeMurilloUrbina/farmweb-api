...
{
    public class ServicioEntrada:IServicio, Repositorio<Entrada>
    {
        ...
        public async Task<Pagination<Entrada>> Obtener(int? page, int? qty)
        {
            var _companies = _repository.Get(page, qty).Result;
            return _companies;
        }
        public async Task<Entrada> Obtener(int id)
        {
        ...
        public async Task<string> Actualizar(Entrada entrada)
        {
            //if (entrada.Id == 0)
            //    return "";
