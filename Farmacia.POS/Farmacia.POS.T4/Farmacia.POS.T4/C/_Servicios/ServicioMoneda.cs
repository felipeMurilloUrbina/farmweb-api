...
{
    public class ServicioMoneda:IServicio, Repositorio<Moneda>
    {
        ...
        public async Task<Pagination<Moneda>> Obtener(int? page, int? qty)
        {
        ...
        public async Task<string> Actualizar(Moneda moneda)
        {
            //if (moneda.Id == 0)
            //    return "";
