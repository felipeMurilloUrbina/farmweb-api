...
{
    public class ServicioLinea:IServicio, Repositorio<Linea>
    {
        ...
        public async Task<Pagination<Linea>> Obtener(int? page, int? qty)
        {
            var _companies = _repository.Get(page, qty).Result;
            return _companies;
        }
        public async Task<Linea> Obtener(int id)
        {
        ...
        public async Task<string> Actualizar(Linea linea)
        {
            //if (linea.Id == 0)
            //    return "";
