...
{
    public class ServicioEmpresa:IServicio, Repositorio<Empresa>
    {
        ...
        public async Task<Pagination<Empresa>> Obtener(int? page, int? qty)
        {
        ...
        public async Task<string> Actualizar(Empresa empresa)
        {
            //if (empresa.Id == 0)
            //    return "";
