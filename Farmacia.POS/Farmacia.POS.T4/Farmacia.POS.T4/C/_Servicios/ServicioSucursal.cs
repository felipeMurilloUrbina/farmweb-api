...
{
    public class ServicioSucursal:IServicio, Repositorio<Sucursal>
    {
        ...
        public async Task<Pagination<Sucursal>> Obtener(int? page, int? qty)
        {
        ...
        public async Task<string> Actualizar(Sucursal sucursal)
        {
            //if (sucursal.Id == 0)
            //    return "";
