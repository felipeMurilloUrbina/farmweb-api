...
{
    public class ServicioAlmacen:IServicio, Repositorio<Almacen>
    {
        ...
        public async Task<Pagination<Almacen>> Obtener(int? page, int? qty)
        {
            var _companies = _repository.Get(page, qty).Result;
            return _companies;
        }
        public async Task<Almacen> Obtener(int id)
        {
        ...
        public async Task<string> Actualizar(Almacen almacen)
        {
            //if (almacen.Id == 0)
            //    return "";
